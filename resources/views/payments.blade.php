...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">MAKE PAYMENTS HERE</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="/submitpayment">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="MPESA" disabled autocomplete="name" autofocus>
